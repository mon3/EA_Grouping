...
plotMetrics<-function(data, numplots, mainlabel, ylabel, maxy){
  ...
  if(numplots==3){
    ...
    legend("topleft", legend=c("kmeans", "agnes euclidean", "pam maximum"), col=c("green", "red", "blue"),lty=1, cex=1.0)
  }
  else{
...
plotMetrics(data = avghk, 3, "Agnes: srednia liczba klastrow dla cec2013(6-15)", "avgK", 15)
...
plotMetrics(data = avgpk, 3, "PAM: srednia liczba klastrow dla cec2013(6-15)", "avgK", 15)
...
plotMetrics(data = avgkk, 1, "K-means: srednia liczba klastrow dla cec2013(6-15)", "avgK", 15)

plotMetrics(data = avgbestdunn, 3, "Najlepsze pary: sredni indeks Dunna dla cec2013(6-15)", "avgDunn", 1.5)
plotMetrics(data = avgbestsil, 3, "Najlepsze pary: sredni wspolczynnik Silhouette dla cec2013(6-15)", "avgSil", 1)
plotMetrics(data = avgbestgin, 3, "Najlepsze pary: sredni odsetek grup o srednich lepszych niz najlepszy dla cec2013(6-15)", "avgGin", 1)
plotMetrics(data = avgbestk, 3, "Najlepsze pary: srednia liczba klastrow dla cec2013(6-15)", "avgK", 15)
